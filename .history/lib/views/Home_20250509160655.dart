          ...
          child: Container(
            child: Column(
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(gradient: LightTheme.appGradient,border: BorderRadius.only(topLeft: Radius.circular(AppConstants.font24Px*2),topRight: Radius.circular(AppConstants.font))),
                  child: Row(
                    children: [
                      Text('18°'),
                      Text('18°'),
