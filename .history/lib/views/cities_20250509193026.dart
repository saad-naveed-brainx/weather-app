      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ReusableCityCard(cityName: 'Islamabad'),
            ReusableCityCard(cityName: 'Lahore'),
            ReusableCityCard(cityName: 'Karachi'),
            ReusableCityCard(cityName: 'Peshawar'),
            ReusableCityCard(cityName: 'Quetta'),
            ReusableCityCard(cityName: 'Rawalpindi'),
            ReusableCityCard(cityName: 'Sialkot'),
            ReusableCityCard(cityName: 'Sukkur'),
          ],
        ),
      ),
    );
