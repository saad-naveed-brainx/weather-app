...
import 'package:weather/config/app_router.dart';
        ...
        return Scaffold(
          appBar: AppBar(
            title: Column(
              children: [
                Text(
                  weather?.cityName ?? ViewConstants.LoadingText,
                  style: TextStyle(
            ...
            actions: [
              IconButton(
                onPressed: () => AppRouter.moveToCities(context),
                icon: Icon(Icons.add),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          weather?.Condition ?? ViewConstants.LoadingText,
                          style: TextStyle(
                            fontSize: AppConstants.font24Px,
                        ...
                        Text(
                          '${weather?.temperature != null ? weather?.temperature : ViewConstants.LoadingText}°',
                          style: TextStyle(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    '${weather?.feelsLike != null ? weather?.feelsLike : 'Loading...'}°',
                                    style: TextStyle(
                                      color: LightTheme.whiteTextColor,
                                      fontSize: AppConstants.font12Px,
                                    ),
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: AppConstants.font12Px),
                                  Text(
                                    '${weather?.visibility != null ? weather?.visibility : 'Loading...'}m',
                                    style: TextStyle(
                                      color: LightTheme.whiteTextColor,
                                      fontSize: AppConstants.font12Px,
                                    ),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: AppConstants.font12Px),
                                  Text(
                                    '${weather?.humidity != null ? weather?.humidity : ViewConstants.LoadingText}%',
                                    style: TextStyle(
                                      color: LightTheme.whiteTextColor,
                                      fontSize: AppConstants.font12Px,
                                    ),
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: AppConstants.font12Px),
                                  Text(
                                    '${weather?.seaLevel != null ? weather?.seaLevel : ViewConstants.LoadingText}m',
                                    style: TextStyle(
                                      color: LightTheme.whiteTextColor,
                                      fontSize: AppConstants.font12Px,
                                    ),
